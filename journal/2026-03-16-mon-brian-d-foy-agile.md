...
One striking idea from Uncle Bob is that _“the purpose of Agile is to destroy hope.”_ That sounds pessimistic at first, but the real meaning is about exposing problems as early as possible. Instead of pretending everything is fine until the deadline arrives, Agile reveals how “messed up” a project might be while there is still time to correct course.
